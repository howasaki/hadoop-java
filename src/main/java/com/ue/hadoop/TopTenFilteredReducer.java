...
public class TopTenFilteredReducer extends Reducer<Text, IntWritable, Text, IntWritable> {
    ...
    protected void setup(Context context) throws IOException, InterruptedException {
        ...
        queue = new PriorityQueue<>(11, Comparator.comparing(AbstractMap.SimpleEntry::getValue));
    }
